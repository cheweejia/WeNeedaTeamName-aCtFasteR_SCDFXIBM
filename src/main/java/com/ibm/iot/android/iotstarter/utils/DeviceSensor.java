...
public class DeviceSensor implements SensorEventListener {
    ...
    // Values used for accelerometer, magnetometer, orientation sensor, proximity sensor data
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (sensorEvent.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            if (sensorEvent.values[0] == 0) {
                Log.v(TAG, "Proximity: Near" + sensorEvent.values[0]);
                P = 1;
            } else {
                Log.v(TAG, "Proximity: Far" + sensorEvent.values[0]);
                P = 0;
            }
//            Log.v(TAG, "Proximity: " + sensorEvent.values[0]);
    ...
    private class SendTimerTask extends TimerTask {
        ...
        public void run() {
            ...
            String messageData = MessageFactory.getProxMessage(G, O, P, yaw, lon, lat, heading, speed, tripId);
            ...
            try {
                ...
                if (app.getConnectionType() == Constants.ConnectionType.QUICKSTART) {
                    ...
                    iotClient.publishEvent(Constants.PROX_EVENT, "json", messageData, 0, false, listener);
                }
            ...
            //if (runningActivity != null && runningActivity.equals(IoTPagerFragment.class.getName())) {
                Intent actionIntent = new Intent(Constants.APP_ID + Constants.INTENT_IOT);
                actionIntent.putExtra(Constants.INTENT_DATA, Constants.PROX_EVENT);
                context.sendBroadcast(actionIntent);
            //}
        }
    }
